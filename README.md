...
**M2 (반복 학습) 완성 · 콘텐츠 확장 중.** 사전 **305개**(초등 277 + 중학교 28) + Leitner 5박스 학습(뜻 고르기·소리 듣고 고르기·철자 채우기·예문 빈칸), 오답 화면, 학습 기록 백업. 학년 선택 `3–4학년·5학년·6학년·중학교`로 노출을 제어하며, 중학교 어휘도 정의는 초등 정의 어휘 안에서만 쓴다. [로드맵](docs/04-roadmap.md) 참조.
